(function($){
    $.fn.AdFloat = function(options){
        var defaults = {
            imgSrc : "", //漂浮图片路径
            url : "https://wx.zjliving.com", //图片点击跳转页
        ...
        var html = "<div id='float_ad' style='position:absolute;left:0px;top:0px;z-index:1000000;cleat:both;'>";
            html += "  <a href='" + options.url + "' " + _target + "><img src='" + options.imgSrc + "' border='0' class='float_ad_img' width=" + options.width + " height=" + options.height + "/></a> <a href='javascript:;' id='close_float_ad' style=''>x</a>";
            html += "</div>";
